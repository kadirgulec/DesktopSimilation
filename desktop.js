...
class item {
    ...
    doubleClicked(number, codeTyp){
        this.item = document.getElementsByClassName("componentItems")[0];
        this.codeTyp = codeTyp;
        this.item.innerHTML = dialogCodes.this.codeTyp;
        dialog.showModal();

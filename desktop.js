...
class item {
    ...
    create(){
        this.componentItems.innerHTML += 
                                    `<div class="item" id="item${this.itemnr}" onclick="item${this.itemnr}.clicked(${this.itemnr})" ondblclick="item${this.itemnr}.doubleClicked(${this.itemnr})">
    ...
    doubleClicked(number){
        ...
        this.dialogBoxes.innerHTML = `<dialog class="dialog dialog1" id="item${this.itemnr}" onload="calculatorLoad()">
        <div class="top-bar">
            <h2>About Me</h2>
            <div class="close-button" onclick="item${this.itemnr}.closeTab(${this.itemnr})">
            </div>
        </div>
        <div class="dialog-content-wrapper">
            <div class="dialog-content">
    ...
    `;
        ...
        let window_tab = document.querySelector(`#item${number}`);
    ...
    closeTab (number) {
        ...
        console.log("closeTab gedrückt");
        console.log(itemIdArray);
        let itemid = document.getElementById(`item${number}`);
        itemid.style.backgroundColor = "rgba(255, 255, 255, 0)";
        console.log(itemid);
    }
